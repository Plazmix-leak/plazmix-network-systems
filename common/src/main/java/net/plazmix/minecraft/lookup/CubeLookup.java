...
public class CubeLookup implements IntersectionLookup<Cube> {

    @Override
    public Collection<Point> scanPolygon(Cube cuboid) {
        return Sets.newHashSet();
    }

    @Override
    public boolean isIntersected(Cube cuboid, Polygon another) {
